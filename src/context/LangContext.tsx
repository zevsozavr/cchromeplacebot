...
const translations = {
  UA: {
    ...
    'checkout.name_required': "Введіть ім'я та прізвище",
    ...
    'cart.shipping.calc': 'Розрахується при оформленні',
    'cart.total': 'Всього',
  ...
  RU: {
    ...
    'checkout.name_required': 'Введите имя и фамилию',
    ...
    'cart.subtotal': 'Сумма',
    'cart.shipping': 'Доставка',
    'cart.shipping.calc': 'Рассчитается при оформлении',
    'cart.total': 'Итого',
